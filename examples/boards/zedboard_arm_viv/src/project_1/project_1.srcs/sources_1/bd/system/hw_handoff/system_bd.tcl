...
proc create_root_design { parentCell } {
  ...
  set axi4_instr_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi4_instr_0 ]
...
CONFIG.C_AUX_RESET_HIGH {0} \
  ...
  # Create instance: vectorblox_mxp_arm_0, and set properties
  set vectorblox_mxp_arm_0 [ create_bd_cell -type ip -vlnv vectorblox.com:ip:vectorblox_mxp:1.0 vectorblox_mxp_arm_0 ]
  set_property -dict [ list \
CONFIG.BEATS_PER_BURST {16} \
CONFIG.C_INSTR_PORT_TYPE {2} \
...
CONFIG.VECTOR_LANES {2} \
 ] $vectorblox_mxp_arm_0

  # Create interface connections
  connect_bd_intf_net -intf_net axi4_instr_0_M00_AXI [get_bd_intf_pins axi4_instr_0/M00_AXI] [get_bd_intf_pins vectorblox_mxp_arm_0/S_AXI_INSTR]
  connect_bd_intf_net -intf_net axi4lite_0_M00_AXI [get_bd_intf_pins axi4lite_0/M00_AXI] [get_bd_intf_pins vectorblox_mxp_arm_0/S_AXI]
  connect_bd_intf_net -intf_net axi_mem_intercon_M00_AXI [get_bd_intf_pins axi_mem_intercon/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins axi4_instr_0/S00_AXI] [get_bd_intf_pins processing_system7_0/M_AXI_GP0]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP1 [get_bd_intf_pins axi4lite_0/S00_AXI] [get_bd_intf_pins processing_system7_0/M_AXI_GP1]
  connect_bd_intf_net -intf_net vectorblox_mxp_arm_0_M_AXI [get_bd_intf_pins axi_mem_intercon/S00_AXI] [get_bd_intf_pins vectorblox_mxp_arm_0/M_AXI]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins axi4_instr_0/ARESETN] [get_bd_pins axi4lite_0/ARESETN] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins axi4_instr_0/M00_ARESETN] [get_bd_pins axi4_instr_0/S00_ARESETN] [get_bd_pins axi4lite_0/M00_ARESETN] [get_bd_pins axi4lite_0/S00_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn] [get_bd_pins vectorblox_mxp_arm_0/aresetn]
  connect_bd_net -net sysclk [get_bd_pins axi4_instr_0/ACLK] [get_bd_pins axi4_instr_0/M00_ACLK] [get_bd_pins axi4_instr_0/S00_ACLK] [get_bd_pins axi4lite_0/ACLK] [get_bd_pins axi4lite_0/M00_ACLK] [get_bd_pins axi4lite_0/S00_ACLK] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins vectorblox_mxp_arm_0/core_clk]
  connect_bd_net -net sysclk_2x [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins vectorblox_mxp_arm_0/core_clk_2x]

  # Create address segments
  create_bd_addr_seg -range 0x00100000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs vectorblox_mxp_arm_0/S_AXI_INSTR/INSTR_PORT] SEG_vectorblox_mxp_arm_0_INSTR_PORT
  create_bd_addr_seg -range 0x00010000 -offset 0xB0000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs vectorblox_mxp_arm_0/S_AXI/SCRATCHPAD] SEG_vectorblox_mxp_arm_0_SCRATCHPAD
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces vectorblox_mxp_arm_0/M_AXI] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
